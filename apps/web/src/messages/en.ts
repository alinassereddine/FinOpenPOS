const messages = {
  ...
  categories: {
    ...
    deleteMessage: "Are you sure you want to delete this category? Products in this category will be unassigned.",
  ...
  sales: {
    ...
    dayItems: "Day Items",
    avgSale: "Avg. Sale",
    allTimeStats: "All-time: {count} sales · {revenue} revenue",
    transactions: "Transactions",
    noSales: "No sales on this day",
    completeSale: "Complete a sale to see it here",
    today: "Today",
